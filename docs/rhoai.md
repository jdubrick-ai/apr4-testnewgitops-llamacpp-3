...
3) Access the `workbench` named `apr4-testnewgitops-llamacpp-3-notebook`.
...
5) In the terminal, run `cd apr4-testnewgitops-llamacpp-3` to navigate to your sample app's directory.
